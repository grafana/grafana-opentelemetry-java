    ...
    String testedVersion =
        String.format(
            "Grafana OpenTelemetry Javaagent: version=%s, "
                + "includeAllInstrumentations=false, useTestedInstrumentations=true, includedUntestedInstrumentations=[], excludedInstrumentations=[]",
        ...
        Arguments.of(
            named(
                ...
                new TestCase(
                    Map.of(),
                    Map.of(),
                    ("Grafana OpenTelemetry Javaagent: version=%s, includeAllInstrumentations=true, useTestedInstrumentations=false, "
                            + "includedUntestedInstrumentations=[], excludedInstrumentations=[]")
            ...
            named(
                ...
                new TestCase(
                    ...
                    ("Grafana OpenTelemetry Javaagent: version=%s, includeAllInstrumentations=false, "
                            + "useTestedInstrumentations=false, "
