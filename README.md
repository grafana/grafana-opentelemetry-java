...
5. Choose a **Service Name** to identify your service (e.g. `cart`)
...
Finally, make a few requests to your service (to make sure it sends data to Grafana Cloud) and observe your service in
